...
class ConcernBoardPage extends StatefulWidget {
  ConcernBoardPage({Key key}) : super(key: key);

  @override
  _ConcernBoardPageState createState() => _ConcernBoardPageState();
}

class _ConcernBoardPageState extends State<ConcernBoardPage> {
  ScrollController _controller;
  List<Index> _indexes = [];
  Map<String, dynamic> _params;

  getData() {
    DataUtils.getConcernBoardTopicList(_params).then((resultList) {
      setState(() {
